...
import { SESSIONS, DEFAULT_WEEK } from "@/lib/sessions";
...
export default function Home() {
  ...
  const handleSubmit = useCallback(
    async (question: string) => {
      ...
      if (mode === "webllm" && loadStatus !== "ready") {
      ...
      try {
        ...
        if (mode === "webllm") {
          ...
          await streamWebLLM(promptMessages, onToken);
        } else {
    ...
    [isStreaming, mode, loadStatus, cloudApiKey, cloudProvider, cloudModelName, selectedWeek]
  );
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="px-5 py-3 border-b border-gray-200 bg-white shrink-0">
          <p className="text-xs text-gray-500">Course · Digital AI Strategy</p>
